/* growth.js — Go-to-market section of the product book.
   Six pages: countries and buyers, the four buyers, the funnel, the offer ladder,
   the payback model (interactive) and retention. Loads after data.js, before app.js.
   app.js inserts growthPages into corePages and merges growthRenderers. */
...
/* ---------- The four buyers ---------- */
const gtmPersonas=[
{t:"The solo operator",s:"A consultant, fractional executive or founder doing their own selling.",
 trigger:"A revenue push they must run alone, this month.",
 tries:"Uploads one list. Sends a 50-contact campaign from their own mailbox. Puts a booking page in their email signature.",
 upgrades:"Business, for records, projects and the shared inbox; a Campaign licence when volume grows.",
 stays:"Booking links already in circulation, the history of every client conversation, and templates that took evenings to write.",
 leaves:"Between projects, to save money. Answer with the pause plan and a free Personal downgrade that keeps their data — most return with the next project.",
 offer:"Annual with two months free, plus the Launch service."},
{t:"The five-person firm",s:"An agency, recruiter, MSP or brokerage. The centre of the market and the best unit economics.",
 trigger:"Outreach, replies, calls and client delivery live in five disconnected tools and one spreadsheet.",
 tries:"The shared CRM, the approval flow on one live client campaign, one project handover.",
 upgrades:"Campaign and Calling licences, record tiers, and later the agency master account.",
 stays:"No seat tax means the whole firm is inside within a month. Client work and client history sit in the same place; leaving means re-explaining every account.",
 leaves:"When only one person adopted it. Counter with the 30-day activation programme and a weekly usage digest to the owner.",
 offer:"The founding offer. This persona is who it is designed for."},
{t:"The champion inside a company",s:"A sales lead or ops manager in a 20–200 person company, tired of the stitched stack or the dialler bill.",
 trigger:"A renewal notice from an incumbent, or a new outbound target from above.",
 tries:"A one-team calling pilot. Replaces one seam — usually the dialler or the outbound tool — not the whole stack.",
 upgrades:"Licences across further teams, API access, admin controls, reporting.",
 stays:"Ported numbers, months of call outcomes, and manager dashboards the team runs on.",
 leaves:"When IT or procurement vetoes, or the incumbent discounts at renewal. Counter with the security page, a paid pilot whose fee credits the annual plan, and landing small enough to sit under approval thresholds.",
 offer:"A$990 four-week paid pilot, fully credited against the annual plan."},
{t:"Agencies and consultants as a channel",s:"The same firms as the five-person buyer — but selling for you, not only buying.",
 trigger:"They already run campaigns for clients and resell tooling today.",
 tries:"One client workspace under their own account.",
 upgrades:"The agency master account: separated client workspaces, pooled licences, client approvers.",
 stays:"Their margin and their client relationships now run on the platform.",
 leaves:"If a competitor pays a better margin. Counter with real economics: 20–30% first-year revenue share and co-marketing.",
 offer:"Partner terms. Every referred customer arrives at a fraction of paid CAC — the cheapest acquisition in this plan."}
];

/* ---------- Email, card, first spend ---------- */
const gtmFunnel=[
...
function fsCalc(){
  ...
  for(let t=1;t<=60;t++){
    ...
    if(t%12===0&&t<60)cash[t]+=fA*Math.pow(.75,t/12)*10*m;           // annual renewals at 75%
    if(t%24===0&&t<60)cash[t]+=fF*Math.pow(.70,t/24)*14*m;           // founding renewals at 70%, founding terms
  }
